...
<body style="margin:0;padding:0;background-color:#f4f4f5;font-family:Arial,Helvetica,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f4f4f5;padding:40px 0;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:32px;">
            <h2 style="margin:0 0 8px;color:#1a1a1a;font-size:18px;">Password Reset Code</h2>
            <p style="margin:0 0 20px;color:#6b7280;font-size:14px;line-height:1.6;">
              You requested a password reset for your <strong>Hosanna Electric</strong> account.
              Use the code below to verify your identity:
            </p>
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" style="padding:16px 0;">
                  <div style="display:inline-block;padding:16px 40px;background-color:#f3f4f6;border-radius:12px;
                              letter-spacing:8px;font-size:32px;font-weight:700;color:#1a1a1a;">${code}</div>
                </td>
              </tr>
            </table>
  ...
  await transporter.sendMail({
    from: `"${process.env.SMTP_FROM_NAME || 'Hosanna Electric'}" <${process.env.SMTP_FROM_EMAIL || 'noreply@example.com'}>`,
    to,
    subject: 'Your Hosanna Electric password reset code',
    html,
  });
}
